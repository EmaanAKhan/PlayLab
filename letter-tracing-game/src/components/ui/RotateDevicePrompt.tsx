 ...
 * top of the screen. CSS (globals.css → .rotate-prompt) limits it to portrait
 * phone-sized viewports; on top of that it now auto-dismisses after 7 seconds
 * so it never lingers. It never blocks touches.
 */
